...
<?php if (!RASPI_MONITOR_ENABLED) : ?>
    ...
    <?php if ($__template_data['serviceStatus'] == 'down') : ?>
        <input type="submit" class="btn btn-success" name="startScoreboardService" value="<?php echo _("Start Scoreboard service"); ?>" />
    <?php else : ?>
        <input type="submit" class="btn btn-warning" name="stopScoreboardService" value="<?php echo _("Stop Scoreboard service"); ?>" />
    <?php endif; ?>
<?php endif ?>
            ...
            <div class="card-body">
                ...
                <form role="form" action="<?php echo $__template_data['action']; ?>" method="POST" class="needs-validation" novalidate>
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" id="scoreboardsettingstab" href="#scoreboardsettings" data-bs-toggle="tab"><?php echo _("Settings"); ?></a></li>
                        <li class="nav-item"><a class="nav-link" id="scoreboardstatustab" href="#scoreboardstatus" data-bs-toggle="tab"><?php echo _("Status"); ?></a></li>
                        <li class="nav-item"><a class="nav-link" id="scoreboardabouttab" href="#scoreboardabout" data-bs-toggle="tab"><?php echo _("About"); ?></a></li>
                    </ul>
